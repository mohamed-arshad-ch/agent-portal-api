import{d as h,r as E,u as F,g8 as y,j as e,F as x,T as f,I as q,G as ne,bi as pe,dI as he,B as g,a3 as ge,t as me,S,dE as fe,bo as oe,aJ as xe,g9 as be,a7 as G,ga as je,be as N,a0 as ye,H as se,bt as Ce,b as ae,y as K,z as Y,A as P,C as z,D as _,E as Q,bX as U,bY as ee,bg as we,bV as Te}from"./strapi-BdtmSf-H.js";import{u as R,A as $e,g as p,a as ie,C as te}from"./index-cD82V-TB-DE2KGz7Q.js";import"./groupBy-CH1gSvgI.js";import"./_baseEach-BpvGlZTQ.js";import"./index-7v6h3MY8.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";import"./sortBy-DBYBXyo7.js";import"./_baseMap-B2HVFb-b.js";const ve=h(g)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,Be=h(x)`
  ...
  align-items: center;
`,Se=({customRowComponent:t,components:n=[],addComponent:o,name:s,targetUid:r})=>{const{isInDevelopmentMode:i}=R(),[c,j]=E.useState(0),{formatMessage:b}=F(),m=a=>{c!==a&&j(a)},u=()=>{o(s)};return e.jsx(re,{className:"dynamiczone-row",$isFromDynamicZone:!0,children:e.jsxs("td",{colSpan:12,children:[e.jsx(Fe,{paddingLeft:8,children:e.jsxs(Re,{gap:2,children:[i&&e.jsx("button",{type:"button",onClick:u,children:e.jsxs(Be,{direction:"column",alignItems:"stretch",gap:1,children:[e.jsx(Ae,{}),e.jsx(f,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:b({id:p("button.component.add"),defaultMessage:"Add a component"})})]})}),e.jsx(x,{role:"tablist",gap:2,children:n.map((a,l)=>e.jsx(Ie,{dzName:s||"",index:l,component:a,isActive:c===l,isInDevelopmentMode:i,onClick:()=>m(l)},a))})]})}),e.jsx(De,{children:n.map((a,l)=>{const d={customRowComponent:t,component:a};return e.jsx(g,{id:`dz-${s}-panel-${l}`,role:"tabpanel","aria-labelledby":`dz-${s}-tab-${l}`,style:{display:c===l?"block":"none"},children:e.jsx("table",{children:e.jsx("tbody",{children:E.createElement(le,{...d,isFromDynamicZone:!0,component:r,key:a})})})},a)})})]})})},Ne=h(g)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
